    ...
    public class LoopingProcessor : GPUFrameProcessor<LoopingProcessorSettings>
    {
        ...
        protected override bool DrawSidePanelContent(bool hasChanged)
        {
            ...
            using (new GUI.ClipScope(preview_rect))
            {
                ...
                GUI.Label(new Rect(0, 0, 32, 16), "In:", ImageSequencer.styles.miniLabel);
                Handles.DrawLine(new Vector3(72, 8), new Vector3(width + 40 - 32, 8));
                GUI.color = bottomTrackColor;
                Handles.color = bottomTrackColor;
                GUI.Label(new Rect(0, height-16, 32, 16), "In:", ImageSequencer.styles.miniLabel);
                Handles.DrawLine(new Vector3(72, height - 8), new Vector3(width + 40 - 32, height - 8));
                GUI.color = Color.white;
                Handles.color = Color.white;
                GUI.Label(new Rect(0, height, 32, 16), "Out:", ImageSequencer.styles.miniLabel);
                GUI.Label(new Rect(40, height, 32, 16), "1", ImageSequencer.styles.miniLabel);
                GUI.Label(new Rect(width+40-32, height, 32, 16), length.ToString(), ImageSequencer.styles.miniLabelRight);
                Handles.DrawLine(new Vector3(72, height + 8), new Vector3(width + 40 - 32, height + 8));
            }
            ...
            using (new GUI.ClipScope(gradient_rect))
            {
                ...
                GUI.color = topTrackColor;
                GUI.Label(new Rect(0, 0, 32, 16), (syncF - seqLen + 1 ).ToString(), ImageSequencer.styles.miniLabel);
                GUI.Label(new Rect(width-32, 0, 32, 16), (syncF).ToString(), ImageSequencer.styles.miniLabelRight);
                GUI.color = bottomTrackColor;
                GUI.Label(new Rect(0, height-16, 32, 16), (syncF+1).ToString(), ImageSequencer.styles.miniLabel);
                GUI.Label(new Rect(width-32, height-16, 32, 16), (syncF+seqLen).ToString(),ImageSequencer.styles.miniLabelRight);
                GUI.color = Color.white;
